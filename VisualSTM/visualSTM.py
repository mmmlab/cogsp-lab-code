...
# deal with broken function signature in v2024.1.4
dlg_args = myDlg.addField.__code__.co_varnames
if 'key' in dlg_args:
    # use arguments compatible with v2024.1.4
    ...
    # use arguments compatible with earlier versions
