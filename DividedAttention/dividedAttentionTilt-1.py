...
if instruction[0] == 'G' or 'g':
    instructions = "For the experiment watch the circles presented and remember the location of the specific circle with a grating tilt different from the rest."
    msg = visual.TextStim(win=mywin, text=instructions)
    msg.draw()
    mywin.flip()    
if instruction[0] == 'N' or 'n':
    instructions = "For the experiment pay attention to the letters shown and find the number presented in the set."
    msg = visual.TextStim(win=mywin, text=instructions)
    msg.draw()
    mywin.flip()
else:
    instructions = "For the experiment watch the circles presented and remember the location of the specific circle with a grating different from the rest. Also, remember the number in the series of letters."
    msg = visual.TextStim(win=mywin, text=instructions)
    msg.draw()
    mywin.flip()
